...
** LIVE DEMO!
#+begin_src sh
while 1; do cd /users/fabrik42/desktop/single-file-ruby-programs/rbgif; time ruby -x ./rbgif.gif; sleep 0.1; done
#+end_src
* One more thing...
#+begin_src sh
#!/bin/sh
...
- [[https://greg.molnar.io/blog/a-single-file-rails-application/][A Single file Rails Application | Greg Molnar]]
- [[https://fly.io/ruby-dispatch/single-file-rails-app/][Single File Rails Apps · Fly]]
